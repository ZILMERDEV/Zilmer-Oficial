...
// URL da página de TC Externos
const wixPageUrl = 'https://zilmertransformado.wixsite.com/zilmer/tc-externos';

const downloadDir = path.join(__dirname, '../public/images/produtos/instrumentos/tc-externos');
...
async function main() {
  console.log('🔍 Extraindo imagens de TC Externos do Wix...\n');
  ...
  try {
    ...
    for (let i = 0; i < relevantImages.length; i++) {
      ...
      const filename = `tc-externo-${i + 1}${ext}`;
