...
// URL da página de TC Internos
const wixPageUrl = 'https://zilmertransformado.wixsite.com/zilmer/tc-internos';

const downloadDir = path.join(__dirname, '../public/images/produtos/instrumentos/tc-internos');
...
async function main() {
  console.log('🔍 Extraindo imagens de TC Internos do Wix...\n');
  ...
  try {
    ...
    for (let i = 0; i < relevantImages.length; i++) {
      ...
      const filename = `tc-interno-${i + 1}${ext}`;
