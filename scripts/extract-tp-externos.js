...
// URL da página de TP Externos
const wixPageUrl = 'https://zilmertransformado.wixsite.com/zilmer/tp-externos';

const downloadDir = path.join(__dirname, '../public/images/produtos/instrumentos/tp-externos');
...
async function main() {
  console.log('🔍 Extraindo imagens de TP Externos do Wix...\n');
  ...
  try {
    ...
    for (let i = 0; i < relevantImages.length; i++) {
      ...
      const filename = `tp-externo-${i + 1}${ext}`;
